  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-6 py-16">
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-steel">Sign in to manage your bookings faster.</p>
      </div>
      ...
      <p className="mt-2 text-center text-xs text-steel/70">Demo auth — no real credentials are stored remotely.</p>
    </div>
  );
}
